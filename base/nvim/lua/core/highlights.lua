...
M.colors = {
    ...
    maroon = palette.kanagawa.sakuraPink,
...
M.telescope = {
    ...
    TelescopePreviewBorder = { fg = color.surface0, bg = color.mantle },
    TelescopeResultsBorder = { fg = color.surface0, bg = color.mantle },
