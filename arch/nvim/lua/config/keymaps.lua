...
-- Standard Operations
keymap.set("n", "j", "v:count == 0 ? 'gj' : 'j'", { desc = "Move cursor down", noremap = true, silent = true, expr = true })
...
keymap.set("n", "<leader>q", "<cmd>confirm q<cr>", { desc = "Quit", noremap = true, silent = true, desc = "Quit" })
