return {
  {
    ...
    config = function()
      ...
      -- remove below if to delete fuzed layout
      -- local telescope = require "telescope"
      ...
      -- remove above if to delete fuzed layout
        ...
        defaults = {
          ...
          create_layout = function(picker)
            ...
            function layout:update()
              local box_1, box_kind_1 = get_box()
              prepare_layout_parts(layout, box_kind_1)
              layout_update(self, { size = get_layout_size(box_kind_1) }, box_1)
            end
